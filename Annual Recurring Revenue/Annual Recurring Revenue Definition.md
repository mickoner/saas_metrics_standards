...
ARR does not include contracted but not yet live ARR, and does not include known, but not yet recognized churned or down-sell ARR. See the [Contracted ARR standard](https://#) for its definition.
...
## Calculation Formula
$$\text{ARR} = (\text{MRR} \times 12)^1$$

<sup>1</sup> MRR is the most recent monthly recurring revenue
...
#### Calculation Formula
$$(\$833,333 \times 12)^1 = \$10,000,000 \text{ ARR}$$

<sup>1</sup> No future known events, including churn or new contracts signed but not yet in production are included

### Sample Calculation #2: Calculation at end of Fiscal Month - but not end of Fiscal year

#### List of Input Values
MRR (Sep, 2022): $750,000
Committed ARR not live by September 30, 2022: $150,000
Known future Churn or Downsell ARR on September 30, 2022: $50,000

#### Calculation Formula
$$(\$750,000 \times 12)^1 = \$9,000,000$$

<sup>1</sup> No future but not yet in production  ARR or known down-sell or churn is used in this calculation

## Links to related Standards
Contracted Annual Recurring Revenue (CARR) Standards: [Click Here](http://#)
